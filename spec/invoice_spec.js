                                                            ...
                                                            frisby.create('Set task1 accepted')
                                                              ...
                                                              .afterJSON(function(){
                                                                ...
                                                                frisby.create('Check that user balance is updated')
                                                                  ...
                                                                  .expectStatus(200)
                                                                  .afterJSON(function(user){
                                                                      expect(user.balance_account_state).toBe(balance_user_1 + 50);
                                                                  })
                                                                  .toss();
                                                                frisby.create('Check that team3 balance is updated')
                                                                  ...
                                                                  .expectStatus(200)
                                                                  .afterJSON(function(team){
                                                                      expect(team.balance_account_state).toBe(balance_team_1 + 50);
                                                                                  ...
                                                                                  frisby.create('Set task2 accepted')
                                                                                    ...
                                                                                    .afterJSON(function(){
                                                                                      ...
                                                                                      frisby.create('Check that user2 balance is updated')
                                                                                        ...
                                                                                        .expectStatus(200)
                                                                                        .afterJSON(function(user){
                                                                                            expect(user.balance_account_state).toBe(balance_user_2 + 20);
                                                                                        })
                                                                                        .toss();
                                                                                      frisby.create('Check that team2 balance is updated')
                                                                                        ...
                                                                                        .expectStatus(200)
                                                                                        .afterJSON(function(team){
                                                                                            expect(team.balance_account_state).toBe(balance_team_2 + 20);
                                                                                        })
                                                                                        .toss();
                                                                                          ...
                                                                                          frisby.create('Check no resolver for task2')
                                                                                            ...
                                                                                            .afterJSON(function(){
                                                                                                frisby.create('Check that user2 balance is decreased')
                                                                                                  ...
                                                                                                  .expectStatus(200)
                                                                                                  .afterJSON(function(user){
                                                                                                      expect(user.balance_account_state).toBe(balance_user_2);
                                                                                                  })
                                                                                                  .toss();

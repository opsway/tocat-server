...
insert into users values(1, "Dev1", 'dev1', 1, 50, now(), now(), 2, true, 'dev1@opsway.com', true);
insert into users values(2, "Dev2", 'dev2', 2, 60, now(), now(), 2, true, 'dev2@opsway.com', true);
insert into users values(5, "Dev5", 'dev5', 2, 61, now(), now(), 2, true, 'dev5@opsway.com', true);
insert into users values(3, "Dev3", 'dev3', 3, 70, now(), now(), 2, true, 'dev3@opsway.com', true);
insert into users values(4, "Dev4", 'dev4', 3, 80, now(), now(), 2, true, 'dev4@opsway.com', true);
insert into users values(6, "Dev6", 'dev6', 1, 40, now(), now(), 2, true, 'dev6@opsway.com', true);
insert into users values(7, "inactive", 'inactive', 1, 40, now(), now(), 2, false, 'inactive@opsway.com', true);
insert into users values(8, "Manager1", 'man1', 1, 40, now(), now(), 1, true, 'man1@opsway.com', true);
insert into users values(9, "Manager2", 'man2', 2, 40, now(), now(), 1, true, 'man2@opsway.com', true);
insert into users values(10, "Manager3", 'man3', 3, 40, now(), now(), 1, true, 'man3@opsway.com', true);
insert into users values(11, "Manager4", 'man4', 4, 40, now(), now(), 1, true, 'man4@opsway.com', true);
